...
const updateAccountDetails = asyncHandler(async (req,res) => {
   ...
   const user = User.findByIdAndUpdate(
    ...
    return res.status(200).json(new ApiResponse(200,user,"Acounted details updated successfully"))
})
...
const updateUserAvatar = asyncHandler(async (req,res) => {
   ...
   if(!avatar.url){
    throw new ApiError(400,"Errir while uploading in avatar")
   }
...
const updateUserCoverImage = asyncHandler(async (req,res) => {
   ...
   if(!coverImage.url){
    throw new ApiError(400,"Errir while uploading in Cover Image")
   }
...
const getWatchHistory = asyncHandler(async(req,res) => {
    ...
    return res.status(200).json(
        new ApiResponse(200,user[0].watchHistory,"Watch History Fetched successg=fully")
    )
})
